...
import { SECTOR_ALLOCATION_DATA } from '../../utils/placeholder-data';
  ...
  useEffect(() => {
    ...
    chart.setOption({
      ...
      series: [{
        ...
        data: SECTOR_ALLOCATION_DATA.map(d => ({
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden bg-white">
      ...
      <div className="flex items-center justify-center border-b border-[#EDE8F2] px-4 bg-[#EDE8F2] py-2 pb-2 shrink-0">
        <h3 className="text-base font-normal text-[#242424]">Sector Allocation</h3>
      </div>

      {/* ── Chart ── */}
      <div className="h-[200px] shrink-0" ref={chartRef} />
      ...
      <div className="flex-1 overflow-y-auto divide-y divide-gray-100">
        {SECTOR_ALLOCATION_DATA.map((item, idx) => (
          <div
            key={idx}
