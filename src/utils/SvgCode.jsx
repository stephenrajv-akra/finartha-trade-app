...
export const Folder = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <g clip-path="url(#clip0_552_36759)">
                <path d="M2 6C2 5.204 2.316 4.442 2.879 3.879C3.442 3.316 4.204 3 5 3H9L9.099 3.005C9.328 3.028 9.543 3.129 9.707 3.293L12.414 6H19C19.796 6 20.558 6.316 21.121 6.879C21.44 7.198 21.68 7.582 21.828 8H7.305C6.898 8 6.5 8.125 6.165 8.356C5.873 8.559 5.64 8.836 5.491 9.157L5.433 9.298L4.054 12.974C3.86 13.491 4.122 14.067 4.639 14.261C5.156 14.455 5.733 14.193 5.927 13.676L7.061 10.649C7.207 10.259 7.58 10 7.998 10H21L21.217 10.012C21.433 10.036 21.643 10.094 21.841 10.185C21.895 10.21 21.948 10.238 22 10.268C22.199 10.383 22.377 10.531 22.525 10.707C22.713 10.929 22.85 11.189 22.928 11.469C23.005 11.749 23.02 12.042 22.973 12.328C22.972 12.336 22.97 12.344 22.968 12.352L21.973 17.562C21.842 18.248 21.476 18.866 20.937 19.311C20.467 19.7 19.891 19.935 19.287 19.988L19.026 20H5C4.204 20 3.442 19.684 2.879 19.121C2.316 18.558 2 17.796 2 17V6Z" fill="#EDE8F2" />
            </g>
            <defs>
                <clipPath id="clip0_552_36759">
...
export const Inbox = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <g clip-path="url(#clip0_552_36762)">
                <path d="M22 7.53516V17.0002C22 17.7654 21.7077 18.5017 21.1827 19.0584C20.6578 19.6152 19.9399 19.9503 19.176 19.9952L19 20.0002H5C4.23479 20.0002 3.49849 19.7078 2.94174 19.1829C2.38499 18.6579 2.04989 17.9401 2.005 17.1762L2 17.0002V7.53516L11.445 13.8322L11.561 13.8982C11.6977 13.965 11.8478 13.9997 12 13.9997C12.1522 13.9997 12.3023 13.965 12.439 13.8982L12.555 13.8322L22 7.53516Z" fill="#EDE8F2" />
                <path d="M19.0003 4C20.0803 4 21.0273 4.57 21.5553 5.427L12.0003 11.797L2.44531 5.427C2.69604 5.01977 3.04053 4.6784 3.45002 4.43138C3.85951 4.18436 4.32214 4.03886 4.79931 4.007L5.00031 4H19.0003Z" fill="#EDE8F2" />
            </g>
            <defs>
                <clipPath id="clip0_552_36762">
                    <rect width="24" height="24" fill="white" />
                </clipPath>
            </defs>
        </svg>
...
export const File = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <g clip-path="url(#clip0_552_36767)">
                <path d="M16 3C16.2652 3.00006 16.5195 3.10545 16.707 3.293L20.707 7.293C20.8946 7.48049 20.9999 7.73481 21 8V18C21 18.7956 20.6839 19.5587 20.1213 20.1213C19.5587 20.6839 18.7956 21 18 21H6C5.20435 21 4.44129 20.6839 3.87868 20.1213C3.31607 19.5587 3 18.7956 3 18V6C3 5.20435 3.31607 4.44129 3.87868 3.87868C4.44129 3.31607 5.20435 3 6 3H7V7C7.00003 7.24493 7.08996 7.48134 7.25272 7.66437C7.41547 7.84741 7.63975 7.96434 7.883 7.993L8 8H14C14.2652 8 14.5196 7.89464 14.7071 7.70711C14.8946 7.51957 15 7.26522 15 7V3H16ZM12 11C11.2222 10.9996 10.4747 11.3018 9.91578 11.8426C9.35682 12.3835 9.03019 13.1206 9.005 13.898C9.0016 13.9319 8.99993 13.9659 9 14C9 14.5933 9.17595 15.1734 9.50559 15.6667C9.83524 16.1601 10.3038 16.5446 10.8519 16.7716C11.4001 16.9987 12.0033 17.0581 12.5853 16.9424C13.1672 16.8266 13.7018 16.5409 14.1213 16.1213C14.5409 15.7018 14.8266 15.1672 14.9424 14.5853C15.0581 14.0033 14.9987 13.4001 14.7716 12.8519C14.5446 12.3038 14.1601 11.8352 13.6667 11.5056C13.1734 11.1759 12.5933 11 12 11ZM13 3V6H9V3H13Z" fill="#EDE8F2" />
            </g>
            <defs>
                <clipPath id="clip0_552_36767">
                    <rect width="24" height="24" fill="white" />
                </clipPath>
            </defs>
        </svg>
...
export const GridBlocks = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <g clip-path="url(#clip0_552_36770)">
                <path d="M5 3H10C10.2652 3 10.5196 3.10536 10.7071 3.29289C10.8946 3.48043 11 3.73478 11 4V7C11 7.26522 10.8946 7.51957 10.7071 7.70711C10.5196 7.89464 10.2652 8 10 8H4C3.73478 8 3.48043 7.89464 3.29289 7.70711C3.10536 7.51957 3 7.26522 3 7V5C3 4.46957 3.21071 3.96086 3.58579 3.58579C3.96086 3.21071 4.46957 3 5 3Z" fill="#EDE8F2" />
                <path d="M14 3H19C19.5304 3 20.0391 3.21071 20.4142 3.58579C20.7893 3.96086 21 4.46957 21 5V13C21 13.2652 20.8946 13.5196 20.7071 13.7071C20.5196 13.8946 20.2652 14 20 14H14C13.7348 14 13.4804 13.8946 13.2929 13.7071C13.1054 13.5196 13 13.2652 13 13V4C13 3.73478 13.1054 3.48043 13.2929 3.29289C13.4804 3.10536 13.7348 3 14 3Z" fill="#EDE8F2" />
                <path d="M14 16H20C20.2652 16 20.5196 16.1054 20.7071 16.2929C20.8946 16.4804 21 16.7348 21 17V19C21 19.5304 20.7893 20.0391 20.4142 20.4142C20.0391 20.7893 19.5304 21 19 21H14C13.7348 21 13.4804 20.8946 13.2929 20.7071C13.1054 20.5196 13 20.2652 13 20V17C13 16.7348 13.1054 16.4804 13.2929 16.2929C13.4804 16.1054 13.7348 16 14 16Z" fill="#EDE8F2" />
                <path d="M4 10H10C10.2652 10 10.5196 10.1054 10.7071 10.2929C10.8946 10.4804 11 10.7348 11 11V20C11 20.2652 10.8946 20.5196 10.7071 20.7071C10.5196 20.8946 10.2652 21 10 21H5C4.46957 21 3.96086 20.7893 3.58579 20.4142C3.21071 20.0391 3 19.5304 3 19V11C3 10.7348 3.10536 10.4804 3.29289 10.2929C3.48043 10.1054 3.73478 10 4 10Z" fill="#EDE8F2" />
            </g>
            <defs>
                <clipPath id="clip0_552_36770">
                    <rect width="24" height="24" fill="white" />
                </clipPath>
            </defs>
        </svg>
...
export const Bell = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <g clip-path="url(#clip0_552_36777)">
                <path d="M14.235 19C15.1 19 15.557 20.024 14.98 20.668C14.6051 21.0875 14.1459 21.4229 13.6323 21.6525C13.1188 21.8821 12.5625 22.0005 12 22C11.4374 22.0005 10.8812 21.8821 10.3676 21.6525C9.85404 21.4229 9.3948 21.0875 9.01997 20.668C8.46797 20.052 8.86197 19.089 9.65397 19.007L9.76397 19.001L14.235 19Z" fill="#EDE8F2" />
                <path d="M11.9999 2C13.3579 2 14.5059 2.903 14.8749 4.141L14.9209 4.312L14.9289 4.355C16.0313 4.9769 16.9707 5.8511 17.6702 6.906C18.3696 7.9609 18.8092 9.16648 18.9529 10.424L18.9809 10.711L18.9999 11V13.931L19.0209 14.067C19.1579 14.8038 19.5656 15.4627 20.1639 15.914L20.3309 16.031L20.4929 16.13C21.3529 16.617 21.0529 17.896 20.1159 17.994L19.9999 18H3.99995C2.97195 18 2.61295 16.636 3.50695 16.13C3.88798 15.9144 4.21719 15.618 4.47149 15.2616C4.72578 14.9052 4.89899 14.4974 4.97895 14.067L4.99995 13.924L5.00095 10.954C5.06192 9.64788 5.44211 8.37661 6.10823 7.25147C6.77436 6.12632 7.70611 5.18161 8.82195 4.5L9.06995 4.354L9.07995 4.311C9.2214 3.71303 9.54289 3.17284 10.001 2.76334C10.4592 2.35384 11.0319 2.09473 11.6419 2.021L11.8239 2.004L11.9999 2Z" fill="#EDE8F2" />
            </g>
            <defs>
                <clipPath id="clip0_552_36777">
                    <rect width="24" height="24" fill="white" />
                </clipPath>
            </defs>
        </svg>
